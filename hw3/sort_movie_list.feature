...
Scenario: sort movies alphabetically
  ...
  Then I should see "2001: A Space Odyssey" before "Aladdin"
    ...
    #And I should see "Chocolat" before "Hulk, The Incredible"
    #And I should see "Hulk, The Incredible" before "Raiders of the Lost Ark"
...
Scenario: sort movies in increasing order of release date
  ...
  Then I should see "1968-04-06" before "1981-06-12"
    ...
    #And I should see "2004-11-05" before "2009-01-26"
    #And I should see "2009-01-26" before "2011-08-10"
